[![Build Status](https://travis-ci.org/zekriyassine/js-training.svg?branch=master)](https://travis-ci.org/zekriyassine/js-training)

## Setup

First, [**fork**](https://github.com/zekriyassine/js-training/fork?fragment=1) this repository.
...
_our tester may include bugs, feel free to check the code and fix it_
...
- add your test file _(ex: `exercises/my-test.js`)_
...
_All the tests must be written using [assert](https://nodejs.org/api/assert.html)
for `./tester` to work properly._
